...
import camketImage from '../assets/images/Cam kết.png';
const Introduction = () => {
    return (
            ...
            <Navbar />
                <div className={styles.container}>
                    <div className={styles.Header}>
                        ...
                        <img src={Logo} alt="Logo Bình Minh store" />
                    </div>
                    <div className={styles.Content}>
                       <section className={styles.Section1}>
                        ...
                        <section className={styles.Section3}>
                            <img src={camketImage} alt="Cam kết từ trái tim" />
                        </section>
                        ...
                        <img src={Logo} alt="Logo Bình Minh store" className={styles.Logo}/>
                    </div>
                </div>
            <Footer />
        </div>
